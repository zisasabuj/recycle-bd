// rename to .cjs if "type": "module" in package.json
const { Client } = require('pg');

async function main() {
  const client = new Client({
    connectionString: 'postgresql://neondb_owner:***@ep-polished-forest-adonhcpe.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require',
